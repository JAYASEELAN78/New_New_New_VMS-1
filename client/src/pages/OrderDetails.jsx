...
import { HiOutlineArrowLeft, HiOutlineCheckCircle, HiOutlinePaperAirplane, HiOutlineTrash, HiOutlineExclamationCircle } from 'react-icons/hi'
                            ...
                            <div className="flex flex-wrap gap-3 w-full md:w-auto">
                                {!showConfirm ? (
                                    <button
                                        ...
                                        className="px-4 py-2 border border-red-200 text-red-600 bg-white rounded-lg text-sm font-semibold hover:bg-red-50 flex items-center justify-center gap-2 w-full md:w-auto text-center transition-colors"
                                    >
                                        <HiOutlineTrash className="w-4 h-4" />
                                        Cancel Order
                                    </button>
                                ) : (
                                    <div className="flex items-center gap-3 bg-red-600 p-1 pl-4 rounded-lg shadow-md animate-pulse">
                                        <span className="text-white text-xs font-bold whitespace-nowrap flex items-center gap-2">
                                        ...
                                        <div className="flex gap-1">
                                            <button
                                                ...
                                                className="bg-white text-red-600 px-3 py-1 rounded font-black text-xs hover:bg-red-50 disabled:opacity-50"
                                            >
                                                YES
                                            </button>
                                            <button
                                                onClick={() => setShowConfirm(false)}
                                                className="bg-red-700 text-white px-3 py-1 rounded font-black text-xs hover:bg-red-800"
                                            >
                                                NO
                                            </button>
                                        </div>
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 border border-amber-300 text-amber-700 bg-white rounded-lg text-sm font-semibold hover:bg-amber-50 flex-1 md:flex-none text-center"
                                >
                                    Negotiate
                                </button>
                                <button
                                    ...
                                    className="px-6 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg text-sm font-bold shadow-md flex-1 md:flex-none text-center"
                                >
                                    Accept Price
                                </button>
                            </div>
